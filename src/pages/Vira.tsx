        ...
        <>
            <div className="bg-gradient-to-b from-[#00000087] to-teal-800 h-screen">
                <div className="flex flex-col items-center">
                    <h1 className="text-white md:text-4xl text-2xl md:my-8 my-0 md:mt-0 mt-16">You are invited to</h1>
                ...
                <div className="text-white flex flex-col justify-center items-center my-12">
                    ...
                    <p className="mt-4 md:mb-8 mb-16 md:text-2xl text-base flex justify-center items-center md:w-[488px] md:px-0 px-12 h-[55px] rounded-[20px] bg-[rgba(10,1,1,0.20)] backdrop-blur-[5px] border-[2px] border-white">Alif dan Partner</p>
